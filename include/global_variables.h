...
uint16_t rawValues[18];
uint16_t minChannelValue = 1000;
uint16_t maxChannelValue = 2000;
uint16_t blankTime = 2100;
uint8_t pulseCounter = 0;
uint64_t microsAtLastPulse = 0;
uint32_t ppm_pulse_timeout = 100000; //timeout in ms
bool send_RC_Override = false;
...
//=================================================================================================
    ...
    typedef enum fc_io_set { fc_ser = 0, fc_bt = 1 , fc_wifi = 2, fc_sd = 3 , fc_en = 4} fc_io_t;
