...
#define mvBaud            115200        // Mavlink to/from the flight controller - max 921600 - must match FC or long range radio
...
#define FC_Mavlink_IO  4    //ESP-Now
...
#define APchannel            1                  // The wifi channel to use for our AP
...
//=================================================================================================
//                            E S P  N O W  O P T I O N S  
//=================================================================================================

#define RECVR_MAC {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF} // MAC Address of receiver
#define WIFI_CHAN  1 // WIFI CHannel for ESP Now
#define Heartbeat_Timeout 2500 // Timout for heartbeat until we set to connection lost in ms
#define PPM_Input
#define PPM_Pin 18
#define PPM_Channels 18
